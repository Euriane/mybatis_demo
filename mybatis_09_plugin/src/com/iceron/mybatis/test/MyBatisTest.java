...
public class MyBatisTest {
	 ...
	 * 		他里面包含Configuration以及 Executor（根据全局配置文件中的defaultExecutorType创建出对应的Executor）
	...
	public void test() throws IOException {
		...
		try {
			...
			Employee employee = mapper.getEmpById(25);
	 ...
	 */
	/**
	 * 插件编写： 见 MyFirstPlugin.java
	 * 1、编写Interceptor的实现类
	 * 2、使用@Intercepts注解完成插件签名
	 * 3、将写好的插件注册到全局配置文件中
	 * 
	 */
	//运行上面的test()方法  测试写好的插件
}
